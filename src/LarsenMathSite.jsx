            ...
            <div className="lm-wrap lm-reveal">
              ...
              <div className="lm-grid-2" style={{ marginTop: 28 }}>
                ...
                <div className="lm-card">
                  ...
                  <p className="lm-body" style={{ marginTop: 12 }}>
                    Best for structured weekly practice with other learners. Only a maximum of five (5) learners are allowed per class.
                  </p>
                </div>
              </div>
              <p className="lm-caption" style={{ marginTop: 20, textAlign: "center" }}>
                No commitment. No upfront payment before details are confirmed. Pricing depends on the grade.
              </p>
            </div>
          </section>
